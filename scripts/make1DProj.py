...
#DIPHOTON
    ...
    for hMRTOT, hMRData, hMRSignal, hRSQTOT, hRSQData, hRSQSignal, hBTAGTOT, hBTAGData, hBTAGSignal, btagOpt, frLabel in zip(hMRTOTList, hMRDataList,  hMRSignalList, hRSQTOTList, hRSQSignalList, frLabels):
